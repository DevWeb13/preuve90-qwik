...
Deux tâches sont prévues : publication éventuelle d’un pronostic et règlement des rencontres terminées. Elles restent **inactives** tant que toutes leurs préconditions opérationnelles ne sont pas acceptées.
